...
from yazelc.systems.player_system import PlayerSystem, Inventory
...
class Game:
    ...
    def initialize(self):
        ...
        player_system = PlayerSystem(self.config.player, Inventory(), self.game_state.world, self.game_state.resources)
